...
sémantique distribué sous la licence libre \glslink{lgpl}{LGPL} écrit en
langage Python. 

Ces dernières années les entreprises proposent de plus en plus leur services
via des applications web (\textit{\glslink{saas}{Software As A Service}}) et
...
\glslink{REST}{REST}. REST est un style d'architecture pour les systèmes
