...
du respect des contraintes de l'architecture \glslink{REST}{REST} dans 
CubicWeb. Un document \glslink{cwep}{CWEP} a été rédigé qui détaillent les 
...
\glslink{crud}{CRUD} en respectant REST. La solution fonctionne dans CubicWeb
...
Les deuxième objectif qui est de refondre dans CubicWeb le code nécessaire pour
...
La solution proposée pour réaliser des opérations \glslink{crud}{CRUD} sur les 
...
Durant le stage j'ai appris à utiliser le gestionnaire de version Mercurial.
