...
très influencée par la méthode \glslink{methodexp}{XP}, \glslink{scrum}{Scrum}
et \glslink{kanban}{Kanban}. En utilisant une méthode agile, un projet est
...
pratiques de la méthode \glslink{xp}{XP} et de Scrum. Nous utilisons un tableau
...
Des pratiques de la méthode XP sont appliquées tout au long du développement.
...
développement est piloté par les tests (\glslink{tdd}{TDD}), les tests sont
...
\glslink{pairprogramming}{\textit{pair programming}}.

L'objectif du VSprint est de permettre le partage des connaissances et de
