...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage[
    style=super, toc, nopostdot, 
    xindy={language=french, 
    codepage=utf8}, acronym, ]{glossaries} 
...
\newacronym{url}{URL}{Uniforme Resource Locator}
...
\newlength\totalwidth \setlength\totalwidth{\dimexpr\textwidth+\marginwidth}
...
{\cleardoublepage\vspace*{\fill}\thispagestyle{empty}} {\vfill\cleardoublepage}
\renewenvironment{abstract}[1] {\bigskip\selectlanguage{#1}%
\begin{center}\bfseries\abstractname\end{center}} {\par\bigskip}
...
\begin{document} 
    ...
    \include{titlepage} 
    \include{abstract} \include{thanks}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% \nocite{*} \cleardoublepage \phantomsection
